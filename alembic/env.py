"""Alembic environment. Uses the sync psycopg driver -- migrations don't
benefit from async and the sync path is far easier to debug."""
...
def include_object(obj, name, type_, reflected, compare_to):
    # Never let autogenerate drop the LangGraph checkpointer's own tables.
    if type_ == "table" and name.startswith(("checkpoint", "writes")):
        return False
    return True
